...
Open `lib/features/notes/data/remote/note_remote_datasource.dart` and update the base URL:
...
**Sync returns 404**
- Verify the backend is deployed and the `_baseUrl` matches your Railway domain
